    ...
    <section class="ftco-gallery ftco-section ftco-no-pb">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters">
					...
					<div class="col-md-4 col-lg-2 ftco-animate">
						<a href="<?php echo base_url();?>assets/images/gallery-6.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(<?php echo base_url();?>assets/images/gallery-6.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
